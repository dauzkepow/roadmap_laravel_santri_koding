...
//import beberapa hook react router dom
...
export default function AppRoutes() {
    //destructure context "isAuthenticated", cek status otentikasi true atau false
    ...
    return (
        <Routes>
            ...
            {/*route hanya bisa diakes user yang sudah login */}


            {/* route "/register", jika sudah terotentikasi maka akan ke dashboard */}
            ...
            <Route path="/admin/dashboard" element={
                //jika sudah otentikasi tampilkan dashboard, jika false redirect ke login
