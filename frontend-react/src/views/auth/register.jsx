...
export default function Register() {
    ...
    //definisikan state untuk menampung nilai dalam form
    ...
    //method register dijalankan saat form di submit
    const register = async (e) => {
        ...
        await api.post('/api/register', {
            ...
            .catch(error => {
                //jika gagal registrasi, assign error to state "validation"
            ...
            <div className="row justify-content-center">
                <div className="card border-0 rounded shadow-sm">
                    <div className="card-body">
                        ...
                        <hr />
                        {
                            //untuk menampilkan validasi di JSX
                            validation.errors && (
